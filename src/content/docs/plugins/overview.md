...
一秋小镇服务器共安装了 **46** 个插件，覆盖了版本兼容、经济商店、领地保护、传送家园、社交聊天、奖励系统、性能优化、世界管理、视觉展示和基础服务等多个方面。以下按类别对所有插件进行详细分组介绍。

[!TIP]
点击各插件名称旁的链接可查看该插件的详细 Wiki 页面。部分插件可能暂无独立页面，管理员会逐步完善文档。
...
| QuickShop-Hikari | 6.2.0.11 | 玩家商店系统，支持创建个人商店 |
...
| 插件名称 | 版本 | 说明 |
| :--- | :--- | :--- |
| Dominion | 4.8.4-release-lite | 轻量级领地保护系统 |
...
| 插件名称 | 版本 | 说明 |
| :--- | :--- | :--- |
| HuskHomes | 4.11 | 玩家家园与传送点管理系统 |
| HuskHomesGUI | 2.5.1 | HuskHomes 的 GUI 图形界面 |
| CompassCommand | 1.2JE17 | 指南针导航命令 |
...
| 插件名称 | 版本 | 说明 |
| :--- | :--- | :--- |
| AuthMe | 5.7.0-FORK | 玩家登录验证（正版/离线模式） |
| LuckPerms | 5.5.49 | 高级权限管理系统 |
...
| 插件名称 | 版本 | 说明 |
| :--- | :--- | :--- |
| [Worlds](/docs/misc/worlds) | 4.3.0-pre1 | 多世界管理系统 |
| WorldEdit | 7.4.1-SNAPSHOT | 世界编辑工具 |
...
| 插件名称 | 版本 | 说明 |
| :--- | :--- | :--- |
| squaremap | 1.3.13 | 在线网页地图 |
| FancyNpcs | 2.11.0 | 自定义 NPC 系统 |
| SkinsRestorer | （核心） | 皮肤恢复与管理 |
...
| item-nbt-api | 2.15.7 | 物品 NBT 数据操作库 |
| vanishpp | 1.1.8 | 隐身模式增强 |
